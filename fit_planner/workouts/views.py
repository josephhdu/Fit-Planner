...
hf_token = "your_hugging_face_access_token"  # Replace this with your actual access token
...
def generate_workout(request):
    if request.method == 'POST':
        ...
        test_prompt = (
            ...
            f"1. Schedule: {user_schedule}\n"
            f"2. Workout Duration: {workout_duration}\n"
            f"3. Preferred Workout Areas: {workout_areas}\n"
            f"4. Fitness Level: {fitness_level}\n"
            f"5. Fitness Goals: {fitness_goals}\n"
            f"6. Available Equipment: {equipment}\n\n"
